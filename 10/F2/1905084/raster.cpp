...
void zBufferScan() {
    ...
    for (int t=0; t<triangles.size(); t++) {
        ...
        for (int r = topLine; r < bottomLine; r++) {
            ...
            else leftPoint = (xa-leftX)/2.0 * screenWidth;
            if (xb > -leftX) rightPoint = screenWidth-1;
            else rightPoint = (xb-leftX)/2.0 * screenWidth;
